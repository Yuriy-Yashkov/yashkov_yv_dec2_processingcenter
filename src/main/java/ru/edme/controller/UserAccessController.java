...
public class UserAccessController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<UserAccess> findById(@PathVariable("id") Long id) {
    ...
    @ApiResponse(responseCode = "404", description = "Пользователь не найден")
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> delete(@Parameter(description = "ID пользователя", example = "1") @PathVariable("id") Long id) {
